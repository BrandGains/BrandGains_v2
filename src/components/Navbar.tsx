  ...
  return (
    <header
      className={`fixed flex flex-col md:flex-row w-full ${
        isOpen ? "h-full" : "h-fit"
      } justify-between text-slate-200 px-5 md:px-10 z-50 bg-gradient-to-b from-[#021814ac] to-[#05372f14] backdrop-blur-sm`}
    >
      ...
      {isOpen && (
        <div className="mobile-menu flex flex-col justify-evenly h-full w-full">
          <ul className="flex flex-col justify-center items-start gap-10 w-full">
            <li className=" w-full px-5 text-2xl">
              <Link href={"#"} className="hover:text-slate-50">
                Services
              </Link>
            </li>
          ...
          <div className="social-links flex justify-between w-full">
            <Link href={"https://instagram.com"} className="hover:text-slate-50">
              <LuInstagram />
            </Link>
            <Link href={"https://twitter.com"} className="hover:text-slate-50">
